    ...
    class BaseForm extends AuthComponent {
        ...
        getData = () => {
            ...
            form.validateFields((errors, params) => {
                ...
                const kPoint = kPointIds
                    ? [kPointIds.id || kPointIds.treeId]
                    : []
        ...
        render() {
            ...
            const { category, warningInfo } = this.state
                            ...
                            <div className='formStyle'>
                                <FormItem {...layout} label='学科'>
                                    {getFieldDecorator('category', {
                                        ...
                                        >
                                            <RadioButton
                                                value={Q_CATEGORY.MATH}
                                            >
                                                数学
                                            </RadioButton>
                                            <RadioButton
                                                value={Q_CATEGORY.ENGLISH}
                                            >
                                                英语
                                            </RadioButton>
                                        </RadioGroup>
                                ...
                                <FormItem
                                    ...
                                    label='关联知识点'
                                >
                                    {getFieldDecorator('kPointIds', {
                                        initialValue: initPoint
