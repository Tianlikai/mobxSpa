...
class TopMethod extends AuthComponent {
  ...
  render() {
    const { title, STATE, isSuperRight, handleHistoryBack } = this.props
    return (
      <BoxHeader>
        <Button
        ...
        {isSuperRight && STATE !== 3 && typeof STATE !== 'undefined' ? (
          <Button
        ...
        {!isSuperRight && STATE !== 1 && typeof STATE !== 'undefined' ? (
          <Button
            className='self-right-submit'
            size='large'
            type='primary'
